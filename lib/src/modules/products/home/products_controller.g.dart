...
mixin _$ProductsController on ProductsControllerBase, Store {
  ...
  late final _$_errorMessageAtom =
      Atom(name: 'ProductsControllerBase._errorMessage', context: context);
  ...
  late final _$loadProdcutsAsyncAction =
      AsyncAction('ProductsControllerBase.loadProdcuts', context: context);

  @override
  Future<void> loadProdcuts() {
    return _$loadProdcutsAsyncAction.run(() => super.loadProdcuts());
  }
